  ...
  inquirer
    .prompt([
      // Prompt for logo text
      {
        ...
        validate: (text) =>
          text.length <= 3 || "Must enter 3 characters or less.", // Validate text length
      },
      ...
      // Prompt for text colour
      {
        name: "textColour",
        message:
          "Pick a colour for your text (Enter colour keyword or hexadecimal)",
      ...
      // Prompt for shape colour
      {
        name: "shapeColour",
        message:
          "Pick a colour for your shape (Enter colour keyword or hexadecimal)",
        type: "input", // Input prompt for colour entry
      },
    ])
