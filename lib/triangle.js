...
class Triangle extends Shape {
  ...
  render(text, textColour, shapeColour) {
    ...
    return `<svg width='${width}' height='${height}' version='${version}' xmlns='${xmlns}'><polygon points='150,10 20,180 280,180' fill='${shapeColour}' /><text x='150' y='130' font-size='55' font-weight='bold' text-anchor='middle' fill='${textColour}'>${text}</text></svg>`;
  }
}
